...
TEST_CASES = CV_TEST_CASES[:2]
# TEST_CASES = CV_TEST_CASES[2:4]
# TEST_CASES = CV_TEST_CASES[4:6]
# TEST_CASES = CV_TEST_CASES[6:8]
# TEST_CASES = CV_TEST_CASES[8:]
# TEST_CASES = Backend_TEST_CASES[:2]
# TEST_CASES = Backend_TEST_CASES[2:4]
# TEST_CASES = Backend_TEST_CASES[4:6]
# TEST_CASES = Backend_TEST_CASES[6:8]
# TEST_CASES = Backend_TEST_CASES[8:10]