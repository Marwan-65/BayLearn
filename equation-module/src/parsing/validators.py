...
def validate_math_request_structure(request: SolverRequest) -> None:
    ...
    if request.operation == "matrix_ops":
        _enforce_matrix_operation_rules(request)
...
def _enforce_matrix_operation_rules(request: SolverRequest) -> None:
