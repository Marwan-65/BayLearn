...
//this file is the file concerned with the layout(shocker) of the nodes and edges.
//bye7seb el length wl width bta3et kol 7aga wl absolute pixel positions bta3et kol 7aga(msh relative l ay container)
...
const DEFAULTS=  { //can be overridden by a theme passed to computelayout(), yjfg
  SLOT_WIDTH:      52,
  SLOT_HEIGHT:   56,   
...
//3adad el pixels bta3et el node given 3adad el keys eli fi, wl constants eli fo2,
//el nodes eli mafehash wla key hateb2a 52px da el minimum width 3shan lw el node fadya f nos el animation teb2a bayna bardo 
...
//height sabet. padding fo2, slot height, padding ta7t. tada
...
//make a map of depth of each node 3shan neb2a ne3raf ne7seb el y cordinate bta3etha
...
//takes plain state object from btree.js or insert or delete
//takes optional theme object that can ovverride the visual constanats that we set here
//reutunrs the layput map
